...
describe("isRateLimitError", () => {
  it.each([
    ...
    ["litellm.RateLimitError: over TPM", true],
    ['429: {"message":"litellm.RateLimitError: over TPM","code":"429"}', true],
    ["429 status code (no body)", true],
    ["Server requested 90s retry delay (max: 60s). 429 status code (no body)", true],
    ["500 Internal Server Error", false],
    ["maximum context length is 32429 tokens", false],
    ["requested 4290 tokens", false],
    ["you requested 33,429 tokens", false],
    ["max_tokens=429 is invalid", false],
    ["latency 1.429s", false],
    [undefined, false],
    ["", false],
